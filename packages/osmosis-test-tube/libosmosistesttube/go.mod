...
require (
	...
	github.com/osmosis-labs/osmosis/v15 v15.0.0-20230313015533-dee3b5395c8d
...
replace github.com/CosmWasm/wasmd => github.com/osmosis-labs/wasmd v0.30.0-osmo-v15
